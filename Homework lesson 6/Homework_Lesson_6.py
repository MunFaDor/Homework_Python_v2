...
#important - Полинома на 888 е 888 но програмата го представя като 878 заради глобалното условие. Ако се промени така че да изкарва верния полиндром за 888 ще показва грешни за останалите примери. 
...
#explain Функция, която проверява дали дадено число е палиндром. Преобразува числото в низ и сравнява го с низа, обърнат на обратно срещу нормалния.
def nearest_palindrome(num): 
# explain Функция, която намира най-близкия палиндром на дадено число. Тя използва двa цикъла, за да намери най-близкия палиндром, по-малък и по-голям от въведеното число.
    num = int(num)
